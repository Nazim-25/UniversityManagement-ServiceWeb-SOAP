...
<link rel="stylesheet" href="Nom-prenom.css" media="screen">
   <link rel="stylesheet" href="button.css" media="screen">
    ...
    <meta property="og:title" content="Nom prenom">
  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-clearfix u-custom-color-1 u-header u-header" id="sec-dea1"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" id="sec-96eb" data-image-width="1920" data-image-height="1080">
      <div class="u-form u-form-1">
        <form action="ChercherParNomPrenomG.do" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
          <div class="u-form-group u-form-name u-label-top">
            <label for="name-9417" class="u-label">Nom</label>
            <input type="text" placeholder="Saisir le nom" id="name-9417" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
          </div>
          <div class="u-form-email u-form-group u-label-top">
            <label for="name-9417" class="u-label">Prénom</label>
            <input type="text" placeholder="Saisir le prénom" id="name-9417" name="prenom" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
          </div>
