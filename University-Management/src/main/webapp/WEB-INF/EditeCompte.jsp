...
<link rel="stylesheet" href="AjouterCompte.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-clearfix u-custom-color-1 u-header u-header" id="sec-dea1"><div class="u-clearfix u-sheet u-sheet-1">
        <%String type=(String)session.getAttribute("UserTypeToEdit");
        int ID=(int)session.getAttribute("UserUnivIdToEdit");
        Utilisateur USER=(Utilisateur)session.getAttribute("UserToEdit");
        %>
              ...
              <div class="u-align-left u-container-style u-layout-cell u-palette-5-dark-3 u-shape-rectangle u-size-60 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <div class="u-align-left u-form u-form-1">
                    <form action="editeUser.do?idUser=${UserToEdit.id_Utilisateur}" method="POST" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" style="padding: 0px;" source="email" name="form">
                      	<% 
					            if( session.getAttribute("EmailExiste")!= null ){
		                 			out.println("<div class='container'>");
		                 	        out.println(" <div  class='alert alert-danger my-2 text-center' role='alert' >");
					                out.println( session.getAttribute("EmailExiste") );
						            out.println("</div>");
								    out.println("</div>");
					            } %>
                      <div class="u-form-group u-label-top u-form-group-1">
                        <label for="text-94e1" class="u-label" >Nom</label>
                        <input type="text" value="<%out.print(USER.getNom());%>"id="text-94e1" name="nom" class="u-border-5 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-text-palette-4-base u-input-1">
                      </div>
                      <div class="u-form-group u-label-top u-form-group-2">
                        <label for="text-8ee3" class="u-label" >Prenom</label>
                        <input type="text" value="<%out.print(USER.getPrenom());%>"id="text-8ee3" name="prenom" class="u-border-5 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-text-palette-4-base u-input-2">
                      </div>
                      <div class="u-form-email u-form-group u-label-top u-form-group-3">
                        <label for="email-f76a" class="u-label">Email</label>
                        <input type="email" value="<%out.print(USER.getEmail());%>" id="email-f76a" name="email" class="u-border-5 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-text-palette-4-base u-input-3" required="">
                      </div>
                      <div class="u-form-group u-label-top u-form-group-4">
                        <label for="text-2e50" class="u-label">Mot de passe</label>
                        <input type="text" value="<%out.print(USER.getPassword());%>" id="text-2e50" name="pwd" class="u-border-5 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-text-palette-4-base u-input-4">
                      </div>
                      <div class="u-form-group u-form-select u-label-top u-form-group-5">
                        ...
                        <div class="u-form-select-wrapper">
                          <select id="select-28cc"  name="type" class="u-border-5 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-text-palette-4-base u-input-5">
                            <option value="admin" <% if(type.equals("admin")){ out.println("selected");} %>>Admin</option>
                            <option value="agent" <% if(type.equals("agent")){ out.println("selected");} %> >Agent</option>
                          </select>
                      ...
                      <div class="u-form-group u-form-select u-label-top u-form-group-6">
                        ...
                        <div class="u-form-select-wrapper">
                          <select id="select-714e"  name="Univ" class="u-border-5 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-text-palette-4-base u-input-6">
                            <option value="1" <% if(ID==1){ out.println("selected");} %> >Abdelhamid Mehri</option>
                          </select>
                          <svg class="u-caret u-caret-svg u-text-palette-4-base" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" style="fill:currentColor;" xml:space="preserve"><polygon class="st0" points="8,12 2,4 14,4 "></polygon></svg>
                        </div>
                      </div>
                      <div class="u-align-right u-form-group u-form-submit u-label-top">
                        <button class="u-active-palette-1-light-3 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-light-2 u-palette-1-base u-radius-50 u-text-active-white u-text-body-alt-color u-text-hover-white u-btn-1">Modifier compte<br>
                        </button>
