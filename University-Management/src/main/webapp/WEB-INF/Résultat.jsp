<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     ...
     <%@ page  import="UnivServices.EtudiantOperations"%>
     <%@ page  import="Beans.Faculté"%>
        ...
        <table class="u-table-entity">
          ...
          <tbody class="u-table-body">
			<%		
					...
					List<Etudiant> etuds= (List<Etudiant>)session.getAttribute("list"); 
					for(Etudiant etu : etuds){
						 out.println("<tr style='height: 69px;'>");
						 out.println(" <td class='u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-5'>"); out.println(etu.getMatricule());  out.println("</td>");
						 out.println("<td class='u-border-1 u-border-grey-30 u-table-cell'>"); out.println(etu.getNom());  out.println("</td>");
						 out.println(" <td class='u-border-1 u-border-grey-30 u-table-cell'>"); out.println(etu.getPrenom());  out.println("</td>");
						 out.println( "<td class='u-border-1 u-border-grey-30 u-table-cell'>"); out.println(etu.getFaculté().getNomFaculté());  out.println("</td>");
						 out.println(" </tr>");
					}		
					 etuds.clear();
					}
